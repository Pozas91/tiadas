...
from gym_tiadas.gym_tiadas.envs import PressurizedBountifulSeaTreasure


class TestPressurizedBountifulSeaTreasure(unittest.TestCase):
    environment = None
    ...
    def test_init(self):
        ...
        # Default reward is (-1, 0, 0)
        self.assertEqual((-1, 0, 0), self.environment.default_reward)
    ...
    def test_step(self):
        ...
        self.assertEqual([-1, 5, -2], rewards)
        ...
        self.assertEqual([-1, 0, -7], rewards)
        self.assertFalse(is_final)

        # Go to DOWN to get 163 treasure-value.
        ...
        self.assertEqual([-1, 163, -8], rewards)
        self.assertTrue(is_final)
        ...
        self.assertEqual([-1, 175, -11], rewards)
        self.assertTrue(is_final)
